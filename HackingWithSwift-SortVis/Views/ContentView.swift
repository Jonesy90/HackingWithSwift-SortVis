...
struct ContentView: View {
    ...
    */
    ...
    // A property to track the current selection sort positions.
    @State private var selectSortPosition = 0
    ...
    func step() {
        withAnimation {
            ...
            case .select:
//                values.selectSort()
                selectSortPosition = values.selectSort(startPosition: selectSortPosition)
            }
        }
    }
}
